...
FT_GetDeviceInfoDetail(
    ...
    LPDWORD lpdwID,
    LPDWORD lpdwLocId,
    LPVOID pcSerialNumber,
    LPVOID pcDescription,
    FT_HANDLE* pftHandle)
{
    TRACE(
        "dwIndex=%d, lpdwFlags=%d, lpdwType=%d, lpdwID=%d, lpdwLocId=%d, pcSerialNumber=%s, pcDescription=%s, "
        "pftHandle=%p, *pftHandle=%p\n",
        dwIndex,
        *lpdwFlags,
        *lpdwType,
        *lpdwID,
        *lpdwLocId,
        ...
        pftHandle,
        *pftHandle);
    FT_STATUS result = xFT_GetDeviceInfoDetail(
        dwIndex, lpdwFlags, lpdwType, lpdwID, lpdwLocId, pcSerialNumber, pcDescription, pftHandle);
    TRACE(
        "returning %d, dwIndex=%d, lpdwFlags=%d, lpdwType=%d, lpdwID=%d, lpdwLocId=%d, pcSerialNumber=%s, "
        "pcDescription=%s, pftHandle=%p, *pftHandle=%p\n",
        result,
        dwIndex,
        *lpdwFlags,
        *lpdwType,
...
FT_STATUS WINAPI
FT_OpenEx(PVOID pvArg1, DWORD dwFlags, FT_HANDLE* pHandle)
{
...
FT_STATUS WINAPI
FT_SetFlowControl(FT_HANDLE ftHandle, USHORT usFlowControl, UCHAR uXon, UCHAR uXoff)
{
    ...
    TRACE(
        "returning %d, ftHandle=%p, usFlowControl=%d, uXon=%d, uXoff=%d\n",
        result,
        ftHandle,
        usFlowControl,
        uXon,
...
FT_STATUS WINAPI
FT_Read(FT_HANDLE ftHandle, LPVOID lpBuffer, DWORD nBufferSize, LPDWORD lpBytesReturned)
{
    TRACE(
        "ftHandle=%p, lpBuffer=%p, nBufferSize=%d, lpBytesReturned=%d\n",
        ftHandle,
        lpBuffer,
        nBufferSize,
        *lpBytesReturned);
    ...
    TRACE(
        "returning %d, ftHandle=%p, lpBuffer=%p, nBufferSize=%d, lpBytesReturned=%d\n",
        result,
        ftHandle,
        lpBuffer,
        nBufferSize,
...
FT_STATUS WINAPI
FT_Write(FT_HANDLE ftHandle, LPVOID lpBuffer, DWORD nBufferSize, LPDWORD lpBytesWritten)
{
    TRACE(
        "ftHandle=%p, lpBuffer=%p, nBufferSize=%d, lpBytesWritten=%d\n",
        ftHandle,
        lpBuffer,
        nBufferSize,
        *lpBytesWritten);
    ...
    TRACE(
        "returning %d, ftHandle=%p, lpBuffer=%p, nBufferSize=%d, lpBytesWritten=%d\n",
        result,
        ftHandle,
        lpBuffer,
        nBufferSize,
...
FT_SetTimeouts(FT_HANDLE ftHandle, DWORD dwReadTimeout, DWORD dwWriteTimeout)
{
    ...
    TRACE(
        "returning %d, ftHandle=%p, dwReadTimeout=%d, dwWriteTimeout=%d\n",
        result,
        ftHandle,
        dwReadTimeout,
        dwWriteTimeout);
...
FT_SetUSBParameters(FT_HANDLE ftHandle, ULONG ulInTransferSize, ULONG ulOutTransferSize)
{
    ...
    TRACE(
        "returning %d, ftHandle=%p, ulInTransferSize=%d, ulOutTransferSize=%d\n",
        result,
        ftHandle,
        ulInTransferSize,
        ulOutTransferSize);
...
FT_STATUS WINAPI
FT_SetChars(FT_HANDLE ftHandle, UCHAR uEventCh, UCHAR uEventChEn, UCHAR uErrorCh, UCHAR uErrorChEn)
{
    TRACE(
        "ftHandle=%p, uEventCh=%d, uEventChEn=%d, uErrorCh=%d, uErrorChEn=%d\n",
        ftHandle,
        uEventCh,
        uEventChEn,
        uErrorCh,
    ...
    TRACE(
        "returning %d, ftHandle=%p, uEventCh=%d, uEventChEn=%d, uErrorCh=%d, uErrorChEn=%d\n",
        result,
        ftHandle,
        uEventCh,
        uEventChEn,
...
FT_STATUS
FT_GetDriverVersion(FT_HANDLE ftHandle, LPDWORD lpdwDriverVersion)
{
...
FT_STATUS WINAPI
FT_GetLibraryVersion(LPDWORD lpdwDLLVersion)
{
